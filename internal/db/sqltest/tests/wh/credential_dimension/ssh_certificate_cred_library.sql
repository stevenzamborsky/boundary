...
begin;
  ...
  values
    ('p____swidget',  't_________ws', 's___1ws-sths', 'h_____ws__01', 'u_____walter', 'tok___walter', 'abc'::bytea, 'ep1',    's1____walter');
  ...
  prepare select_credential_dimensions as
    select
      ...
      credential_library_username::text, credential_library_key_type::text,          credential_library_key_bits,    credential_library_tll::text,         credential_library_key_id::text,        credential_library_critical_options::text,  credential_library_extensions::bytea,
  ...
  select results_eq(
    ...
    (
      ...
      'admin',                           'rsa',                                      4096,                           'None',                               'None',                                 'None',                                     '{"permit-pty": ""}'::bytea,
