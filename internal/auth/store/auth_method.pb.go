...
var file_controller_storage_auth_store_v1_auth_method_proto_goTypes = []interface{}{
...
func file_controller_storage_auth_store_v1_auth_method_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_controller_storage_auth_store_v1_auth_method_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_controller_storage_auth_store_v1_auth_method_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AuthAccount); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
