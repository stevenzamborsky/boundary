...
func (x *TokenKey) Reset() {
	*x = TokenKey{}
	if protoimpl.UnsafeEnabled {
		mi := &file_controller_storage_kms_store_v1_token_key_proto_msgTypes[0]
...
func (*TokenKey) Descriptor() ([]byte, []int) {
	return file_controller_storage_kms_store_v1_token_key_proto_rawDescGZIP(), []int{0}
}
...
func (x *TokenKeyVersion) Reset() {
	*x = TokenKeyVersion{}
	if protoimpl.UnsafeEnabled {
		mi := &file_controller_storage_kms_store_v1_token_key_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TokenKeyVersion) Descriptor() ([]byte, []int) {
	return file_controller_storage_kms_store_v1_token_key_proto_rawDescGZIP(), []int{1}
}
...
var file_controller_storage_kms_store_v1_token_key_proto_rawDesc = []byte{
	...
	0x31, 0x2f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x6b, 0x65, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	...
	0x6f, 0x74, 0x6f, 0x22, 0x96, 0x01, 0x0a, 0x08, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x4b, 0x65, 0x79,
	...
	0x0f, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x4b, 0x65, 0x79, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e,
	0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x0a,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x49, 0x64, 0x12,
	0x20, 0x0a, 0x0c, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x6b, 0x65, 0x79, 0x5f, 0x69, 0x64, 0x18,
	0x14, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x4b, 0x65, 0x79, 0x49,
...
var (
	file_controller_storage_kms_store_v1_token_key_proto_rawDescOnce sync.Once
	file_controller_storage_kms_store_v1_token_key_proto_rawDescData = file_controller_storage_kms_store_v1_token_key_proto_rawDesc
)

func file_controller_storage_kms_store_v1_token_key_proto_rawDescGZIP() []byte {
	file_controller_storage_kms_store_v1_token_key_proto_rawDescOnce.Do(func() {
		file_controller_storage_kms_store_v1_token_key_proto_rawDescData = protoimpl.X.CompressGZIP(file_controller_storage_kms_store_v1_token_key_proto_rawDescData)
	})
...
func init() { file_controller_storage_kms_store_v1_token_key_proto_init() }
func file_controller_storage_kms_store_v1_token_key_proto_init() {
	if File_controller_storage_kms_store_v1_token_key_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_controller_storage_kms_store_v1_token_key_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_controller_storage_kms_store_v1_token_key_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TokenKeyVersion); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_controller_storage_kms_store_v1_token_key_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_controller_storage_kms_store_v1_token_key_proto_goTypes,
		DependencyIndexes: file_controller_storage_kms_store_v1_token_key_proto_depIdxs,
		MessageInfos:      file_controller_storage_kms_store_v1_token_key_proto_msgTypes,
	}.Build()
	File_controller_storage_kms_store_v1_token_key_proto = out.File
	file_controller_storage_kms_store_v1_token_key_proto_rawDesc = nil
	file_controller_storage_kms_store_v1_token_key_proto_goTypes = nil
	file_controller_storage_kms_store_v1_token_key_proto_depIdxs = nil
}
